...
public class ContractService {
    ...
    public Contract saveContract(ContractRequestDto dto, Customer customer, Cleaning cleaning, RoutineContract routineContract) {
        return contractRepository.save(dto.toEntity(customer, cleaning));
    }
    ...
    // 1회성 청소 요청글 작성
    @Transactional
    public OneContractResponseDto createOneContract(Long customerId,  @Valid ContractRequestDto contractDto) {
        ...
        applicationEventPublisher.publishEvent(
                MatchingRequestEvent.forSingle(newContract.getId(),
                        ...
                        contractDto.getContractDate().plusMinutes(contractDto.getTotalTime()))
        );
